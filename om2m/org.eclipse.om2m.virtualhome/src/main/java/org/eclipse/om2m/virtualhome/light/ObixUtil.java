...
public class ObixUtil {
	...
	public static String getLuminosityDescriptorRep(String appId, String ipeId) {
	...
	public static String getLightDescriptorRep(String appId, String ipeId) {
		String prefix = "/" + Constants.CSE_ID + "/" + Constants.CSE_NAME + "/" + appId;
		Obj obj = new Obj();
	...
	public static String getRegulLightDescriptorRep(String appId, String ipeId) {
		String prefix = "/" + Constants.CSE_ID + "/" + Constants.CSE_NAME + "/" + appId;
		Obj obj = new Obj();
	...
	public static String getLightDataRep(boolean value) {
		Obj obj = new Obj();
		obj.add(new Bool("on", value));
		return ObixEncoder.toString(obj);
	}
 
	public static String getLuminosityDataRep(int value) {
		Obj obj = new Obj();
		obj.add(new Int("luminosity", value));
		return ObixEncoder.toString(obj);
	}
	
	public static String getRegulLightDataRep(boolean on, int tempTh) {
		Obj obj = new Obj();
		obj.add(new Int("lightth", tempTh));
